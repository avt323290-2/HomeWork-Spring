...
public class MyController {
    ...
    /**
     * Главная страница по адресу: <a href="http://localhost:8080">...</a>
     * @param model
    ...
    /**
     * Получение страницы по адресу: <a href="http://localhost:8080/task2">...</a> с задачей №2
     * @param model
    ...
    /**
     * Получение страницы по адресу: <a href="http://localhost:8080/task3">...</a> с пустой формой для заполнения
     * @param model
     * @return
     */
    @GetMapping("/task3")
    ...
    /**
     * Отправка данных из формы по адресу: <a href="http://localhost:8080/task3">...</a> и их вывод на странице
     ...
     */
    @PostMapping("/task3")
    public String formSubmit(@ModelAttribute("input") Input input, Model model) {
        model.addAttribute("input", input.getInput());
        return "result";
    }
}